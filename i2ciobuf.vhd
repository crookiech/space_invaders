...
--VERSION_BEGIN 13.0 cbx_altiobuf_bidir 2013:06:12:18:03:43:SJ cbx_mgl 2013:06:12:18:05:10:SJ cbx_stratixiii 2013:06:12:18:03:43:SJ cbx_stratixv 2013:06:12:18:03:43:SJ  VERSION_END
...
--synthesis_resources = cyclonev_io_ibuf 1 cyclonev_io_obuf 1 
 ...
 ENTITY  i2ciobuf_iobuf_bidir_amo IS 
	 PORT 
	 ( 
 ...
 END i2ciobuf_iobuf_bidir_amo;

 ARCHITECTURE RTL OF i2ciobuf_iobuf_bidir_amo IS
 ...
 END RTL; --i2ciobuf_iobuf_bidir_amo
--VALID FILE
...
ARCHITECTURE RTL OF i2ciobuf IS

	SIGNAL sub_wire0	: STD_LOGIC_VECTOR (0 DOWNTO 0);



	COMPONENT i2ciobuf_iobuf_bidir_amo
	PORT (
			datain	: IN STD_LOGIC_VECTOR (0 DOWNTO 0);
			dataio	: INOUT STD_LOGIC_VECTOR (0 DOWNTO 0);
			dataout	: OUT STD_LOGIC_VECTOR (0 DOWNTO 0);
...
BEGIN
	...
	i2ciobuf_iobuf_bidir_amo_component : i2ciobuf_iobuf_bidir_amo
	PORT MAP (
		datain => datain,
		oe => oe,
		dataout => sub_wire0,
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL i2ciobuf.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL i2ciobuf.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL i2ciobuf.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL i2ciobuf.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL i2ciobuf_inst.vhd FALSE
